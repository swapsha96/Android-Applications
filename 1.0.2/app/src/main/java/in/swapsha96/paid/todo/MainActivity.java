    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                if(editText.getText().toString().trim().length() > 0) {
                    if (dbManager.addList(editText.getText().toString().trim()) == true)
                        ...
                        Toast.makeText(MainActivity.this, "Same name list is already added.", Toast.LENGTH_SHORT).show();
                    editText.setText("");
                    ...
                    Toast.makeText(MainActivity.this, "Enter list name first!", Toast.LENGTH_SHORT).show();
                    editText.setText("");
                }
            }
        });
        button.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                Toast.makeText(MainActivity.this,"Enter the name and touch to add the list.",Toast.LENGTH_SHORT).show();
                return true;
            }
        });
